...
export const STUDENT_LISTS_REQUEST = "STUDENT_LISTS_REQUEST";
export const STUDENT_LISTS_FAIL = "STUDENT_LISTS_FAIL";
export const STUDENT_LISTS_SUCCESS = "STUDENT_LISTS_SUCCESS";
